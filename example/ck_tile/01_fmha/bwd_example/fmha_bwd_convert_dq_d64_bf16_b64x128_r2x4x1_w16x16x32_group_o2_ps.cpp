...
using fmha_block_tile_0  = ck_tile::sequence<64, 128, 64>;
using fmha_block_warps_0 = ck_tile::sequence<2, 4, 1>;
using fmha_warp_tile_0   = ck_tile::sequence<16, 16, 32>;

using fmha_bwd_convert_dq_shape_0 =
    ck_tile::TileFmhaBwdConvertQGradShape<fmha_block_tile_0,
                                          fmha_block_warps_0,
                                          fmha_warp_tile_0>;
...
using fmha_bwd_convert_dq_kernel_0 =
    ck_tile::FmhaBwdConvertQGradKernel<ck_tile::FmhaBwdQGradTilePartitioner<64>,
                                       fmha_bwd_convert_dq_0>;

using convert_dq_trait_0 = fmha_bwd_convert_dq_traits_<64,
                                                             ck_tile::bf16_t,
                                                             true,
                                                             true,
                                                             false,
